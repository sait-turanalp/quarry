...
<p><b>Give your coding agent a map of the codebase.</b></p>

<p>Local semantic search that finds the right file <b>83% of the time in 6 ms</b> — so Claude Code and Codex stop grepping and start answering.</p>

<p>One binary. No API key, no GPU, nothing leaves your laptop.</p>
...
Measured on four real repositories in four languages — **1376 queries**, leakage-free ground truth, an identical output budget of 20 files for every contender.
...
- **The top 10 has a ceiling.** Recall is 83% at 20 results and 76% at 10, and measurement puts the practical limit of ranking alone near 81%. About 10% of benchmark queries are not discriminative enough to identify any file — no ranker fixes those.
