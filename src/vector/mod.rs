...
pub use embedding::{
    CoreMlComputeUnitsConfig, CoreMlSpecializationConfig, EmbeddingExecutionProviderConfig,
    EmbeddingGenerator, EmbeddingRuntimeConfig, FastEmbedGenerator, create_symbol_text,
    create_text_embedding, create_text_embedding_with_max_length,
    create_text_embedding_with_runtime, model_to_string, parse_embedding_model,
};
